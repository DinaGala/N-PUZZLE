...
def a_star(heuristic, field, goal, goal_state, size, g_weight = 1, h_weight = 1):
    ...
    f_cost = g_cost[start] * g_weight + heuristics[heuristic](start, goal, size) * h_weight
    ...
    while open_set:
        ...
        for neighbor in get_neighbors(current, size):
            ...
            f_neighbor = g_neighbor * g_weight + heuristics[heuristic](neighbor, goal, size) * h_weight
